...
class TmsTimesheetControllerTest {
    ...
    void create_timesheet_created() throws Exception {
        ...
        mvc.perform(post("/api/v1/timesheets")
                ...
                .andExpect(jsonPath("$.data.timesheetId").value(101));
    ...
    void get_timesheet_ok() throws Exception {
        ...
        mvc.perform(get("/api/v1/timesheets/{id}", id))
                ...
                .andExpect(jsonPath("$.data.timesheetId").value(id));
        ...
        var req = new BulkUpsertDto(
                ...
                List.of(
                        ...
                        new TimeEntryDto(
                                ...
                                /* entryDate */ LocalDate.parse("2025-09-05"),

                                /* description */ "Backend Refactor",

                                /* hours */ new BigDecimal("5"),

                                /* rateAtEntry */ new BigDecimal("70"),
    ...
    void create_entry_ok() throws Exception {
        ...
        var req = new TimeEntryDto(
                ...
                /* entryDate */ LocalDate.parse("2025-09-06"),

                /* description */ "API Development",

                /* hours */ new BigDecimal("6"),

                /* rateAtEntry */ new BigDecimal("60"),
        ...
        var resp = new TimeEntryDto(
                ...
                /* taskName */ "Backend Task",

                /* id */ 5001,

                /* costAtEntry */ new BigDecimal("360"),

                /* projectName */ "Project-2001"
    ...
    void delete_time_entry_ok() throws Exception {
        ...
        mvc.perform(delete("/api/v1/time-entries/{entryId}", entryId))
                ...
                .andExpect(jsonPath("$.message").value("Time entry deleted successfully"))
