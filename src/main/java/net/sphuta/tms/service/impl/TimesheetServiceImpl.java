...
import net.sphuta.tms.enam.TimesheetStatus; // NOTE: package name as provided (no change)
import net.sphuta.tms.entity.Timesheet;
import net.sphuta.tms.exception.ApiExceptions;
import net.sphuta.tms.repository.TimeEntryRepository;
import net.sphuta.tms.repository.TimesheetRepository;
import net.sphuta.tms.response.PageResponse;
import net.sphuta.tms.service.TimesheetService;
import net.sphuta.tms.util.Mappers;
...
public class TimesheetServiceImpl implements TimesheetService {
     ...
     */
    private net.sphuta.tms.entity.TimeEntry buildEntryFromReq(
            Timesheet t,
            net.sphuta.tms.dto.TimeEntryDtos.TimeEntryCreateRequest r
    ) {
        ...
        return net.sphuta.tms.entity.TimeEntry.builder()
                .timesheet(t)
